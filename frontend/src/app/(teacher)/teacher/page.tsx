...
export default function TeacherDashboard() {
  ...
  const quickStats = [
    ...
    { label: "Lessons Generated", value: stats?.lessonsGeneratedThisWeek ?? 0, icon: FileText, color: "bg-brand-100 text-brand-600" },
    { label: "Students Assessed", value: stats?.assessedCount ?? 0,          icon: Sparkles, color: "bg-teal-100 text-teal-600" },
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <FadeIn delay={0.28}>
          <Link href="/teacher/upload" className="card p-5 hover:border-teal-300 group cursor-pointer block">
            <div className="flex items-center gap-4">
