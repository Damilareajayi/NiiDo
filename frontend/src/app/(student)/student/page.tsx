    ...
    <div className="max-w-4xl mx-auto">
      ...
      {loading ? null : !hasProfile ? (
        ...
        <FadeIn delay={0.08}>
          <motion.div
            whileHover={{ y: -2 }}
            className={`card p-6 mb-6 bg-gradient-to-br ${trackColors[track || ""] || "from-teal-400 to-teal-600"} text-white border-0`}
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <FadeIn delay={0.14}>
          <Link href="/student/read" className="card p-5 hover:border-teal-300 group cursor-pointer block">
            <div className="flex items-center gap-4">
